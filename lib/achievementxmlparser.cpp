...
Achievement Achievement::XmlParser::parseXml(QXmlStreamReader& xml)
{
...
QStringList Achievement::XmlParser::parseXmlDependencies(QXmlStreamReader& xml)
{
...
QStringList Achievement::XmlParser::parseXmlOptions(QXmlStreamReader& xml)
{
    QStringList options;
...
QVariant Achievement::XmlParser::parseXmlProgress(QXmlStreamReader& xml)
{
...
QStringList Achievement::XmlParser::xmlElement() const
{
