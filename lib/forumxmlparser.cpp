...
Forum Forum::XmlParser::parseXml(QXmlStreamReader& xml)
{
    Forum forum;
...
QList<Forum> Forum::XmlParser::parseXmlChildren(QXmlStreamReader& xml)
{
...
QStringList Forum::XmlParser::xmlElement() const
{
