...
Comment Comment::XmlParser::parseXml(QXmlStreamReader& xml)
{
    Comment comment;
...
QList<Comment> Comment::XmlParser::parseXmlChildren(QXmlStreamReader& xml)
{
...
QStringList Comment::XmlParser::xmlElement() const
{
